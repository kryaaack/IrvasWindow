...
var modals = function modals() {
  ...
  findModal('.popup_engineer_btn', '.popup_engineer', '.popup_engineer .popup_close');
  findModal('.phone_link', '.popup', '.popup .popup_close'); //showModalByTime('.popup', 60000);

  findModal('.popup_calc_btn', '.popup_calc', '.popup_calc_close');
  findModal('.popup_calc_button', '.popup_calc_profile', '.popup_calc_profile_close', false);
  findModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false);
};
